...
switch($_GET["action"]) {
	case "add":
		if(!empty($_POST["quantity"])) {
			$result = $conn->query("SELECT * FROM stoneLists WHERE ID='" . $_GET["code"] . "'");
...
<th style="text-align:left;"><strong>Stone Type</strong></th>
...
<div id="product-grid">
	...
	<?php
	$result = $conn->query("SELECT * FROM stoneLists ORDER BY ID ASC");
...
if (!empty($result)) { 
	...
	<div class="product-item">
		...
		<div><strong><?php echo $row["stoneType"]; ?></strong></div>
		<div class="product-price"><?php echo $row["stonePrice"]; ?></div>
